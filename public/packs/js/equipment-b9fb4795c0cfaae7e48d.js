...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + '<form action="" class="formName">' + '<div class="form-group">' + '<input type="datetime-local" placeholder="Set Timer" class="name form-control center" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-b9fb4795c0cfaae7e48d.js.map