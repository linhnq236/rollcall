...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + '<form action="/equipment/ + id" class="formName">' + '<div class="form-group">' + '<input type="datetime-local" placeholder="Set Timer" class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-0d2dac6748e2413c9992.js.map