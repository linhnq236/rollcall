...
$(document).ready(function () {
  ...
  function myTimer() {
    var d = new Date();
    $("#clock1").append("<div id='clock'></div>"); // document.getElementById("clock").innerHTML = d.toLocaleTimeString();
  }

  function turnoff() {
    var d = new Date();
    var day = Date.parse(d);
    var current = Date.parse("2019-11-17T20:04:00.000+07:00");
...
/******/ });
//# sourceMappingURL=equipment-17dfec18b86d4df61723.js.map