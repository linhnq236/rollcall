...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $("#settime form").append('<input type="text" placeholder="Start" id="tags" name=""/>');
    $("#settime form").append('<br><input type="submit" id="savebutton" value="Timer" />');
  });
});
...
/******/ });
//# sourceMappingURL=equipment-38abf3dfd4440b07df23.js.map