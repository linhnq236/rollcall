...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + "<form action='/equipment/" + id + "'method ='GET' class='formName'>" + '<div class="form-group">' + '<input type="datetime-local" name = "equipment[timer]"class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-883ddd3277d2c5475853.js.map