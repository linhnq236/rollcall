...
$(document).ready(function () {
  ...
  console.log(Date.parse("2019-11-17T16:40:00.000+07:00"));
  $.each(gon.equipment, function (index, value) {
    $.each(value, function (e, q) {
      while (Date.parse(q) == Date.parse(d)) {
        console.log(q + ":" + e);
      }
    });
  });
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + "<div id='clock'></div>" + "<form action='' class='formName'>" + '<div class="form-group">' + '<input type="datetime-local" class="timer form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-ecd9bda589002d640ab1.js.map