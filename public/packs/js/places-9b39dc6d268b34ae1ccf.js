...
/* WEBPACK VAR INJECTION */(function(Buffer) {$(document).ready(function () {
  var lat = '';
  ...
  function savePic() {
    ...
    var d = new Buffer(base64image, 'base64').toString('en');
    console.log(d);
...
/******/ });
//# sourceMappingURL=places-9b39dc6d268b34ae1ccf.js.map