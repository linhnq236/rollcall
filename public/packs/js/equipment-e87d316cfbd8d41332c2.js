...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + "<form action='/equipment/" + id + "'method = 'POST' class='formName'>" + '<div class="form-group">' + '<input type="datetime-local" name = "timer"class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-e87d316cfbd8d41332c2.js.map