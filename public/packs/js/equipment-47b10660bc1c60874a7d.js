...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      title: content,
      content: '' + '<form action="" class="formName">' + '<div class="form-group">' + '<input type="datetime" placeholder="Set Timer" class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-47b10660bc1c60874a7d.js.map