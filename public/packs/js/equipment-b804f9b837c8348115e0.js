...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + "<form action='/equipment/" + id + "'method = 'PATCH' class='formName'>" + '<div class="form-group">' + '<input type="datetime-local" class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-b804f9b837c8348115e0.js.map