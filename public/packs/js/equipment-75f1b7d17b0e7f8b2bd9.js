...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + '<form action="/equipment/" class="formName">' + '<div class="form-group">' + '<input type="datetime-local" placeholder="Set Timer" class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-75f1b7d17b0e7f8b2bd9.js.map