      ...
      return $.ajax({
        ...
        if (response['data'] == 2) {
          $.confirm({
            ...
            content: "You checked in" // hides content block.

          });
          console.log("Checked in"); // location.reload();
        } else {
          console.log("Success");
          alert("Roll call susccess."); // location.reload();
        }
...
/******/ });
//# sourceMappingURL=places-7c03b5fb80b104a5c423.js.map