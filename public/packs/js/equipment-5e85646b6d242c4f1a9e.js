...
$(document).ready(function () {
  ...
  $('.timer').click(function () {
    ...
    $.confirm({
      ...
      content: '' + "<form action='/equipment/" + id + "'method ='PUT' class='formName'>" + '<div class="form-group">' + '<input type="datetime-local" name = "equipment[timer]"class="name form-control" required />' + '</div>' + '</form>',
      buttons: {
        formSubmit: {
          text: 'Submit',
          btnClass: 'btn-blue',
...
/******/ });
//# sourceMappingURL=equipment-5e85646b6d242c4f1a9e.js.map