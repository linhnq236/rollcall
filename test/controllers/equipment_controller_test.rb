...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference('Equipment.count') do
      post equipment_index_url, params: { equipment: { active: @equipment.active, equiqment_name: @equipment.equiqment_name } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { active: @equipment.active, equiqment_name: @equipment.equiqment_name } }
