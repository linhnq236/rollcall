...
class NoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post notices_url, params: { notice: { content: @notice.content, end: @notice.end, notice_name: @notice.notice_name, start: @notice.start } }
    end
  ...
  test "should update notice" do
    patch notice_url(@notice), params: { notice: { content: @notice.content, end: @notice.end, notice_name: @notice.notice_name, start: @notice.start } }
