...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { name: @teacher.name, teacher_code: @teacher.teacher_code } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { name: @teacher.name, teacher_code: @teacher.teacher_code } }
